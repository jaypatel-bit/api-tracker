                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-[20px] border border-black/8 bg-white px-4 py-3 pr-12 text-sm outline-none focus:border-[var(--accent)]"
                      placeholder="Minimum 8 characters"
                    />
                    <button
                      type="button"
                      onClick={() => setShowPassword((value) => !value)}
                      className="absolute inset-y-0 right-3 flex items-center text-[var(--muted)] hover:text-[var(--foreground)]"
